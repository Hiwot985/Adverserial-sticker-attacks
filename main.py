...
import sys
sys.path.insert(0, "/Users/hiwotbelaytadesse/Downloads/adversarial-camera-stickers-master/yoloV5")
...
def plot_img_from_normalized_img(img_array, is_normalized=True):
    ...
    plt.savefig('/Users/hiwotbelaytadesse/Downloads/adversarial-camera-stickers-master/image/results.jpg')
    plt.show()
...
class AttackModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.base_model = models.yolov5(pretrained=True).eval()
